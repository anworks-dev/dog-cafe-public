...
function TextInput({
  ...
  return (
    <input
      ...
      className="w-full px-3 py-2.5 md:py-3 text-[13px] md:text-[14px] text-[#3B2F25] bg-[#FAF8F4] border border-[rgba(59,47,37,0.15)] rounded-xl outline-none focus:border-[#6FAA88] focus:ring-2 focus:ring-[#6FAA88]/15 placeholder:text-[#B8AEA8] transition-all"
    />
  );
}
        ...
        <form onSubmit={handleSubmit} className="px-4 py-5 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2.5 text-[13px] text-[#3B2F25] bg-[#FAF8F4] border border-[rgba(59,47,37,0.15)] rounded-xl outline-none focus:border-[#6FAA88] focus:ring-2 focus:ring-[#6FAA88]/15 placeholder:text-[#B8AEA8] resize-none transition-all"
            />
          </div>

          <div className="px-3 py-2.5 bg-[#FAF8F4] border border-[rgba(59,47,37,0.1)] rounded-xl">
            <p className="text-[12px] text-[#9A8878]">送信内容は運営のみが確認します</p>
          </div>
        ...
        >
              ...
              <div className="flex flex-wrap gap-x-8 gap-y-3">
                {CONDITIONS.slice(0, 3).map((c) => (
                  <label key={c} className="flex items-center gap-2 cursor-pointer group">
                    ...
                    <span className="text-[14px] text-[#3B2F25] font-medium">{c}</span>
                  </label>
                ))}
              </div>
              <div className="flex flex-wrap gap-x-8 gap-y-3">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="メニューの特徴やおすすめポイントなど"
              rows={4}
              className="w-full px-3 py-3 text-[14px] text-[#3B2F25] bg-[#FAF8F4] border border-[rgba(59,47,37,0.15)] rounded-xl outline-none focus:border-[#6FAA88] focus:ring-2 focus:ring-[#6FAA88]/15 placeholder:text-[#B8AEA8] resize-none transition-all"
            />
          </div>
          ...
          <div className="text-center">
            <Link href="/" className="text-[13px] text-[#6FAA88] hover:text-[#4A9070] transition-colors">
              ← TOPに戻る
            </Link>
          </div>
        </form>
