...
function Placeholder({
  ...
  if (variant === "sp") {
    return (
      <div
        className={`${size === "sm" ? "w-[80px] h-[80px]" : "w-[120px] h-[120px]"} rounded-lg bg-[#F2E8DC] shrink-0 flex flex-col items-center justify-center gap-1`}
      >
  ...
  return (
    <div
      className={`${size === "sm" ? "w-[80px] h-[80px]" : "w-[120px] h-[120px]"} rounded-lg bg-[#F2E8DC] shrink-0 flex flex-col items-center justify-center gap-1.5`}
    >
...
export default function CafeCardImage({
  ...
  const box =
    size === "sm"
      ? "w-[80px] h-[80px] rounded-lg overflow-hidden shrink-0 bg-[#EDE6DE] relative"
      : "w-[120px] h-[120px] rounded-lg overflow-hidden shrink-0 bg-[#EDE6DE] relative";
